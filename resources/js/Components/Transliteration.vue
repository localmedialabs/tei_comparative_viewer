...
const componentName = "transliteration";
...
// ホバーidと同一のcorrespを持つテキストにtei-hover_abクラスやtei-hover_sクラスを付与もしくは削除する関数
...
onMounted(() => {
  // コンポーネントのルート要素を取得
  const rootElement = document.getElementById("transliteration");
  if (rootElement) {
